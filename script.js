...
const countersRaw = {
  Aamon: ["Saber", "Paquito", "XBorg", "Gusion", "Hayabusa", "Lancelot", "Karina", "Claude", "Moskov", "Karrie", "Angela", "Rafaela", "Mathilda"],
  Akai: ["Claude", "Karrie", "Valir", "Masha", "Karina", "Roger", "Diggie", "Khufra"],
  Aldous: ["Phoveus", "Thamuz", "YuZhong", "Lunox", "Kadita", "Lylia", "Claude", "Karrie", "Moskov", "Karina", "Akai", "Fanny", "Lolita", "Franco", "Khufra"],
  Alice: ["Esmeralda", "Phoveus", "YuZhong", "Valir", "Lunox", "Kadita", "Claude", "Karrie", "Brody", "Gusion", "Saber", "Karina", "Lolita", "Franco", "Khufra"],
  Alpha: ["Phoveus", "Esmeralda", "Thamuz", "Lylia", "Lunox", "Kadita", "Claude", "Brody", "Beatrix", "Fanny", "Ling", "Hayabusa", "Franco", "Kaja", "Atlas"],
  Alucard: ["YuZhong", "Thamuz", "Esmeralda", "Valir", "Kadita", "Lylia", "Claude", "Wanwan", "Brody", "Ling", "Fanny", "Karina", "Atlas", "Khufra", "Franco"],
  Angela: ["Esmeralda", "Phoveus", "YuZhong", "Kadita", "Vale", "Eudora", "Melissa", "Brody", "Beatrix", "Saber", "Karina", "Gusion", "Franco", "Atlas", "Khufra"],
  Arlott: ["Dyrroth", "Ruby", "YuZhong", "Sun", "Argus", "LapuLapu", "Terizla", "Benedetta", "Lancelot"],
  ...
  Aulus: ["Phoveus", "YuZhong", "Thamuz", "Valir", "Lylia", "Kadita", "Claude", "Karrie", "Brody", "Fanny", "Ling", "Akai", "Franco", "Atlas"],
  Aurora: ["Esmeralda", "Phoveus", "YuZhong", "Kadita", "Lunox", "Kagura", "Claude", "Brody", "Beatrix", "Gusion", "Ling", "Hayabusa", "Diggie", "Franco", "Atlas"],
  Badang: ["Wanwan", "Chou", "Khufra", "Benedetta", "Kaja", "Hayabusa", "Lunox", "Aurora", "Moskov", "YuZhong", "Martis", "Gloo", "Phoveus", "Julian"],
  Balmond: ["Barats", "Jawhead", "Kaja", "Franco", "Dyrroth", "Moskov", "Karrie", "Esmeralda", "Sun", "XBorg", "Vale", "Valir", "Baxia", "Phoveus"],
  ...
  LapuLapu: ["Sun", "Benedetta", "Chou", "Terizla", "Dyrroth", "YuZhong", "Arlott", "Kaja"],
  ...
  YuZhong: ["Nana", "Esmeralda", "Aurora", "Wanwan", "Diggie", "Chou", "Selena", "Franco", "Kaja", "Baxia", "Karrie", "LapuLapu"]
};
